        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex items-center justify-between h-[68px]">
            <div className="flex-shrink-0 cursor-pointer flex items-center gap-3" onClick={() => scrollTo("hero")}>
              <img src="/logo-nobg.png" alt="MANA AI" className="h-10 w-10 object-contain" draggable={false} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-6 cursor-pointer" onClick={() => scrollTo("hero")}>
                <img src="/logo-nobg.png" alt="MANA AI" className="h-10 w-10 object-contain opacity-80" draggable={false} />
